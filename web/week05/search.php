...
<body>
  ...
  <div id="options">
    ...
    <form class="hidden" id="week" action="week.php?week=value">
      <h4>Select a week</h4>
    ...
    <!--by day options-->
    <form class="hidden" id="day" action="day.php?id=value">
      <h4>Select a day</h4>
    ...
    <!--view by meal-->
    <form class="hidden" id="meals" action="meal.php?meal=value">
      <h4>Select a meal</h4>
